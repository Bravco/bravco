...
![My Skills](https://skillicons.dev/icons?i=androidstudio,bash,blender,c,cs,cpp,css,dart,bots,django,figma,firebase,flutter,gamemakerstudio,git,github,gradle,godot,html,ai,js,linux,md,mysql,netlify,nodejs,nuxtjs,ps,postgres,powershell,py,sqlite,stackoverflow,supabase,svg,unity,visualstudio,vite,vscode,vue&theme=dark)
